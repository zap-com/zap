<div class="d-flex flex-column">
    <form method="POST" action="{{ route('login') }}" id="formLogin">
        ...
        <div class="form-inner " id='formInner'>
            ...
            <div class="form-row align-items-center">
                <div class="col">
                    <button type="submit" id="submit" class="btn b-btn w-100">{{ __('connect.login-submit') }}</button>
                </div>
    ...
    <form method="POST" action="{{ route('register') }}" id="formRegister" class="d-none">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="emailReg"
        ...
        <div class="form-group">
            <label for="password">{{ __('connect.password') }}</label>
            <input id="passwordReg" type="password" class="form-control @error('password') is-invalid @enderror"
                name="password" required autocomplete="current-password">
        ...
        <div class="form-row align-items-center">
            <div class="col">
                <button type="submit" class="btn b-btn w-100">{{ __('connect.signup-submit') }}</button>
            </div>
    ...
    <div class="d-flex flex-column justify-content-center align-items-center">
        ...
        <a id="registerBtn" class="color-main cursor-pointer">{{ __('connect.signup') }}</a>
    </div>
</div>
