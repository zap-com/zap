...
<footer class="footer font-small bg-light mt-5 mt-md-0">
    <div class="container text-center text-md-left">
        <div class="row">
            <div class="col-md-3 mx-auto d-flex flex-column justify-content-between">
                ...
                <!-- Links -->
                <a class="navbar-brand pl-3 mt-3 mb-2" href="{{ route('home') }}"><img class="img-fluid"
                        src="{{ asset('images/zaplogo.svg') }}" width="40"></a>

                <ul class="list-unstyled">
                    <li>
                        <p class="my-0"><i class="fas fa-id-card mr-2"></i>Partita Iva: 09825600019</p>
                    </li>
                    <li>
                        <p class="my-0"><i class="fas fa-phone mr-2"></i>Telefono: 080 1234567</p>
                    </li>
                    <li>
                        <p class="my-0"><i class="fas fa-map-marked mr-2"></i>Indirizzo: Via da Qui 15, Bari</p>
                    </li>
                </ul>
            ...
            <div class="col-md-3 mx-auto">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="#!"><i class="fas fa-link mr-2"></i>I miei annunci</a>
                    </li>
                    <li>
    ...
    <div class="footer-copyright text-center py-3">© 2020 Copyright:
        <a href="{{ route('home') }}">Zap</a> All rights reserved.
    </div>
